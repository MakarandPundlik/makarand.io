  ...
  const education = [
    {
      ...
      gpa: '3.82/4.0',
      description: 'Graduate studies in computer science with focus on cloud architecture, software engineering, and algorithms.',
      coursework: ['Algorithms Design', 'Object-Oriented Design', 'Cloud Architecture', 'DevOps', 'Software Engineering'],
      achievements: ['Graduate Research & Coursework']
    },
    {
      ...
      gpa: '3.79/4.0',
      description: 'Comprehensive study of electronics and telecommunication engineering with emphasis on software development and system design.',
      coursework: ['Object-Oriented Programming', 'Computer Networks', 'Data Structures and Algorithms'],
      achievements: ['Strong academic performance']
    }
  ];
